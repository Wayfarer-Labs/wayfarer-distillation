...
from self_forcing_utils.scheduler import SchedulerInterface, FlowMatchScheduler
    ...
    def __init__(
        ...
        if is_causal:
            self.model = CausalWanModel.from_pretrained(
                f"Wan-AI/{model_name}", local_attn_size=local_attn_size, sink_size=sink_size)
        else:
            self.model = WanModel.from_pretrained(f"Wan-AI/{model_name}")
        self.model.eval()
