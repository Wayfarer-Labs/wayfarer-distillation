...
class WanT2V:
    ...
    def __init__(
        ...
        pretrained_model_name_or_path = pretrained_model_name_or_path or hub_dir or checkpoint_dir
        logging.info(f"Creating WanModel from {pretrained_model_name_or_path}")
        self.model = WanModel.from_pretrained(pretrained_model_name_or_path)
